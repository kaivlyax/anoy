...
function Dashboard() {
  ...
  return (
    <div className="main-feed-column">
      ...
      {/* Feed Tabs Sticky Header */}
      <div className="feed-tabs-container">
        <div className="feed-pill-tabs" role="tablist">
          <button
            role="tab"
            aria-selected={activeTab === "for-you"}
            className={`feed-pill-tab ${activeTab === "for-you" ? "active" : ""}`}
          ...
          <button
            ...
            className={`feed-pill-tab ${activeTab === "explore" ? "active" : ""}`}
