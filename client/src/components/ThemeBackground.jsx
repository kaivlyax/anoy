...
export function ThemeBackground({ children }) {
  ...
  return (
    <div className="theme-background-container" style={{ background: theme.skyGradient }}>
      {/* Background SVG Artwork Layer */}
      <div className="theme-svg-layer" aria-hidden="true">
        {renderSvgScene(theme.svgType)}
      </div>

      {/* Atmospheric Starry Dust Layer */}
      <div className="theme-stars-layer" aria-hidden="true" />

      {/* Subtle Radiant Vignette Overlay */}
      <div
        className="theme-glow-overlay"
        style={{
